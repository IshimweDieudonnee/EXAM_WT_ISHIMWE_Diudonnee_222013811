...
function showDeleteConfirmation($ID) {
    ...
    function confirmDeletion(ID) {
        window.location.href = '?category_id=' + ID + '&confirm=yes';
    }
...
if(isset($_REQUEST['category_id'])) {
    ...
    if (isset($_REQUEST['confirm']) && $_REQUEST['confirm'] == 'yes') {
        ...
        $stmt = $connection->prepare("DELETE FROM communicationskillscategories WHERE category_id=?");
    ...
    echo "<script>alert('ID is not set.'); window.location.href = 'Categories.php';</script>";
}
